...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <div>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <form id="post-call-form" method="POST" action="" class="opacity-50">
                @csrf
                @method('PATCH')
                ...
                <div class="mb-4">
                    ...
                    <select name="disposition" id="disposition" disabled class="w-full rounded-md border-gray-300 text-sm">
                        <option value="">Select...</option>
                        <option value="voicemail">Voicemail left</option>
                        <option value="no_answer">No answer / disconnected</option>
                        <option value="not_interested">Not interested</option>
                        <option value="interested">Interested — follow up</option>
                        <option value="discovery_booked">Discovery call booked</option>
                        <option value="disqualified">Disqualified</option>
                        <option value="wrong_number">Wrong number</option>
                        <option value="bad_number">Bad number / dead line</option>
                    </select>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="pain_points" id="pain_points" rows="3" disabled
                              class="w-full rounded-md border-gray-300 text-sm"
                              placeholder="What did the lead complain about? What eats their time?"></textarea>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="notes" id="notes" rows="3" disabled
                              class="w-full rounded-md border-gray-300 text-sm"
                              placeholder="Your reflection: opened too fast, good rapport, should have asked X..."></textarea>
                </div>

                <div class="flex gap-3">
                    <button type="submit" data-action="next" disabled
                            class="flex-1 bg-gray-900 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-gray-700 disabled:opacity-50">
                        Save and Next
                    </button>
                    <button type="submit" data-action="stay" disabled
